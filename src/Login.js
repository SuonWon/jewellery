            ...
            <div className="flex flex-col w-80 text-gray-900 bg-white rounded-md pb-12 shadow-xl">
                ...
                <form className="flex flex-col px-7 pt-3 pb-8" onSubmit={handleSubmit}>
                    ...
                    <div className="relative block mt-6">
                        ...
                        <input className="placeholder:italic placeholder:text-gray-500 block bg-transparent text-sm w-full border-b-2 border-b-gray-500 pl-7 py-1 focus:outline-none" onChange={handlePasswordChange} placeholder="Enter password"/>
