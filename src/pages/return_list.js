...
function ReturnList({type = 'I'}) {
    ...
    useEffect(() => {
        setReturnPermission({
            purchase: permissions[15],
            sales: permissions[14],
            issue: permissions[16]
        })
        ...
        // },
        {
            ...
            cell: (row) => (
                <div className="flex items-center gap-2">
                    ...
                    {
                        returnPermission.purchase?.delete || returnPermission.sales?.delete || returnPermission.issue?.delete ? (
    ...
    return (
        <>
        {
            (returnPermission.purchase != null && returnPermission.purchase != undefined) || (returnPermission.sales != null && returnPermission.sales != undefined) || (returnPermission.issue != null && returnPermission.issue != undefined) ? (
                <div className="flex flex-col gap-4 relative max-w-[85%] min-w-[85%]">
                    ...
                    <div className="flex items-center py-3 bg-white gap-4 sticky top-0 z-10">
                        ...
                        {
                            returnPermission.purchase?.create || returnPermission.sales?.create || returnPermission.issue?.create ? (
