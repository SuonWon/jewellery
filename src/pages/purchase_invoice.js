...
function PurchaseInvoice() {
    ...
    const onSubmit = async (purchaseData) => {
        let subData = {
            ...purchaseData.puData,
            disAmt: parseFloat(purchaseData.puData.disAmt),
            subTotal: parseFloat(purchaseData.puData.subTotal),
            grandTotal: parseFloat(purchaseData.puData.grandTotal),
            invoiceNo: "P-00001",
            status: "O",
                ...
                <CardBody className="p-0 pb-4">
                    ...
                    <div className="grid grid-cols-4 gap-2 px-3">
                        <Input
                            ...
                            label="Purchase Date"
                            type="date"
                            {...register("puData.purDate")}
                        />
                        <select className="block w-full p-2.5 border border-blue-gray-200 max-h-[2.5rem] rounded-md focus:border-black" defaultValue="Select Supplier" {...register("puData.supplierCode")}>
            ...
            <div className="grid grid-cols-3 gap-2">
                ...
                <div className="col-span-2 flex flex-col h-fit shadow-md rounded-md p-2">
                    ...
                    <div className="grid grid-cols-4 gap-2 mt-4 items-center text-sm">
                        ...
                        <input className="rounded-md text-right p-2 border border-blue-gray-500" type="number" {...register("puData.subTotal")} />
                    </div>
                    <div className="grid grid-cols-4 gap-2 mt-4 items-center text-sm">
                        <label className="col-span-3 text-end">Discount Amount :</label>
                        <input className="rounded-md text-right p-2 border border-blue-gray-500" type="number" {...register("puData.disAmt")} />
                    </div>
                    <div className="grid grid-cols-4 gap-2 mt-4 items-center text-sm">
                        <label className="col-span-3 text-end">Grand Total :</label>
                        <input className="rounded-md text-right p-2 border border-blue-gray-500"  type="number" {...register("puData.grandTotal")} />
                    </div>
                </div>
            </div>
        </div>
